    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icone', models.CharField(choices=[('lni-cog', 'Engrenagem'), ('lni-stats-up', 'Gráfico'), ('lni-users', 'Usuários'), ('lni-layers', 'Desing'), ('lni-mobile', 'Mobile'), ('lni-rocket', 'Foguete')], max_length=25, verbose_name='Icone')),
            ],
            options={
